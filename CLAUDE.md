...
**v1.0 status:** Built. 264 tests, 35 MCP tools, ~15,978 LOC. 50 commits.
**v1.1 status:** In progress. Live payment demo with robot discovery, IPFS delivery, Stripe + USDC settlement.
