# User Journey: Robot Task Auction Marketplace (v0.1 — The Happy Path)

> **Version:** 0.1 | **Date:** 2026-03-24 | **Story:** Marketplace
>
> This is the foundational user journey document for the marketplace story.
> It describes Sarah's experience hiring a robot for a warehouse sensor reading.
> For technical implementation details, see `DECISIONS.md`, `SCOPE.md`, and `research/synthesis/USER_JOURNEY.md`.
> See also: `USER_JOURNEY_LUNAR_v01.md`, `USER_JOURNEY_PRIVATE_v01.md`.
