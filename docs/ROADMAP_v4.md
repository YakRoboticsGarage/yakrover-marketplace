...
**Owner:** Product
**Last updated:** 2026-04-05 (rev 4.3, v1.1 milestone 2 — Base mainnet USDC + correct user journey)
**Status:** v1.0 built. **v1.1 milestone 2 reached** (265 tests, 35 MCP tools). USDC payment confirmed on Base mainnet with real ERC-8004 robot. Two-phase demo with correct user journey. This roadmap is built around construction site surveying as the wedge market.
